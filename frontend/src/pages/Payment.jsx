...
const Payment = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (paymentMethod === 'stripe') {
      try {
        const { data: { clientSecret } } = await axios.post('https://retreat-backend-wh82.onrender.com//api/create-payment-intent', {
      ...
      try {
        const response = await axios.post('https://retreat-backend-wh82.onrender.com//api/paypal', {
